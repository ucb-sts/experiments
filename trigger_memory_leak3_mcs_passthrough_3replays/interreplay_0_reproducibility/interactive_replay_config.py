...
control_flow = InteractiveReplayer(simulation_config, "experiments/trigger_memory_leak3_mcs_passthrough_3replays/interreplay_0_reproducibility/events.trace")
