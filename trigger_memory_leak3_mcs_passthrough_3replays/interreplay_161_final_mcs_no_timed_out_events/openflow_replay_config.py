...
control_flow = OpenFlowReplayer(simulation_config, "experiments/trigger_memory_leak3_mcs_passthrough_3replays/interreplay_161_final_mcs_no_timed_out_events/events.trace")
