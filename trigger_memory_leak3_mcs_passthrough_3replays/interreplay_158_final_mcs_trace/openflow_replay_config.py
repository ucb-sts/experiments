...
control_flow = OpenFlowReplayer(simulation_config, "experiments/trigger_memory_leak3_mcs_passthrough_3replays/interreplay_158_final_mcs_trace/events.trace")
