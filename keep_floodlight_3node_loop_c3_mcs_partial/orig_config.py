from config.invariant_checks import check_for_loops_or_connectivity
...
control_flow = EfficientMCSFinder(simulation_config, "exp/floodlight_3node_loop_c3/events.trace",
                                  epsilon_seconds=0.15,
                                  invariant_check=check_for_loops_or_connectivity,
