...
control_flow = InteractiveReplayer(simulation_config, "experiments/trigger_priority_mismatch_small_mcs_passthrough/interreplay_0_reproducibility/events.trace")
