...
control_flow = InteractiveReplayer(simulation_config, "experiments/load_balancer_fuzzer_mcs_passthrough/interreplay_140_final_mcs_no_timed_out_events/events.trace")
