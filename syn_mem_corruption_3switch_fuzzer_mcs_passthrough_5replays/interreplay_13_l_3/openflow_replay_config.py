...
control_flow = OpenFlowReplayer(simulation_config, "experiments/syn_mem_corruption_3switch_fuzzer_mcs_passthrough_5replays/interreplay_13_l_3/events.trace")
