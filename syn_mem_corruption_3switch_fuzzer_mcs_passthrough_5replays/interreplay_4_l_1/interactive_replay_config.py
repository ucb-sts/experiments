...
control_flow = InteractiveReplayer(simulation_config, "experiments/syn_mem_corruption_3switch_fuzzer_mcs_passthrough_5replays/interreplay_4_l_1/events.trace")
