from exp.floodlight_3node_loop.orig_config import my_funky_invariant_check
...
control_flow = EfficientMCSFinder(simulation_config, "exp/floodlight_3node_loop/events.trace", epsilon_seconds=0.1,
                                    invariant_check=my_funky_invariant_check,
                                    no_violation_verification_runs=15,
