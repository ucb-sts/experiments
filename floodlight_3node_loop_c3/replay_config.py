...
controllers = [ ControllerConfig(command_line, cwd="../floodlight", port=6633, try_new_ports=False, config_template="experiments/floodlight_3node_loop_c3/floodlightconfig.properties") ]
...
simulation_config = SimulationConfig(controller_configs=controllers,
                                     ...
                                     dataplane_trace="experiments/floodlight_3node_loop_c3/dataplane.trace",
                                     multiplex_sockets=False
                                     )

control_flow = Replayer(simulation_config, "experiments/floodlight_3node_loop_c3/events.trace",
