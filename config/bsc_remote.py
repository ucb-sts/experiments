...
start_cmd = "./start_vms -d %s -r" % work_directory
kill_cmd = "./stop_process -d %s -i %s -r" % (work_directory, "%d")
restart_cmd = "./start_process -d %s -i %s -r" % (work_directory, "%d")
check_status_cmd = "./check_process -d %s -i %s -r" % (work_directory, "%d")
