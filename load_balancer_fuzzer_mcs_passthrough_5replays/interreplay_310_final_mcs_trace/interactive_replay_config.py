...
control_flow = InteractiveReplayer(simulation_config, "experiments/load_balancer_fuzzer_mcs_passthrough_5replays/interreplay_310_final_mcs_trace/events.trace")
