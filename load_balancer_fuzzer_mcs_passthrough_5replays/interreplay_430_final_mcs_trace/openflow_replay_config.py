...
control_flow = OpenFlowReplayer(simulation_config, "experiments/load_balancer_fuzzer_mcs_passthrough_5replays/interreplay_430_final_mcs_trace/events.trace")
