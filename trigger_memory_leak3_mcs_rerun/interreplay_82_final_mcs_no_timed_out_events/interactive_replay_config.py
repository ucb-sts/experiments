...
control_flow = InteractiveReplayer(simulation_config, "experiments/trigger_memory_leak3_mcs_rerun/interreplay_82_final_mcs_no_timed_out_events/events.trace")
