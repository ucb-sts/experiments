...
controllers = [ ControllerConfig(dummy_cmd, cwd="experiments/scripts/bsc", address="10.192.5.196", port=6633, controller_type="bsc", label="c1"), 
                ControllerConfig(dummy_cmd, cwd="experiments/scripts/bsc", address="10.192.5.197", port=6633, controller_type="bsc", label="c2")]
