...
control_flow = OpenFlowReplayer(simulation_config, "experiments/trigger_priority_mismatch_small_mcs_blackbox/interreplay_43_final_mcs_no_timed_out_events/events.trace")
