...
control_flow = InteractiveReplayer(simulation_config, "experiments/trigger_priority_mismatch_small_mcs_blackbox/interreplay_41_final_mcs_trace/events.trace")
