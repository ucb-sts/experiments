...
control_flow = OpenFlowReplayer(simulation_config, "experiments/syn_mem_corruption_3switch_fuzzer_mcs_blackbox/interreplay_13_final_mcs_trace/events.trace")
