...
control_flow = InteractiveReplayer(simulation_config, "experiments/trigger_priority_mismatch_small_mcs_passthrough_10replays/interreplay_10_l_0/events.trace")
