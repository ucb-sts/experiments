...
control_flow = InteractiveReplayer(simulation_config, "experiments/trigger_priority_mismatch_small_mcs_passthrough_10replays/interreplay_17_l_2/events.trace")
